			...
			<div id="main-wrapper">
              ...
              <div align="center">
			    <table width="900" border="0" cellspacing="0" cellpadding="5">
                  <tr>
                    <td height="120" style="vertical-align: middle; text-align: center; font-size:25px; color:#ff711d">User Name đã tồn tại trong cơ sở dữ liệu khách hàng.<br />
                      Bấm &quot;Trở về&quot; để đăng kí lại               <br /></td>
                  </tr>
                  <tr>
                    <td height="24" style="vertical-align:middle;text-align: center;"> 
                    <input type="button" value="Trở về" onclick="window.location='dangky.asp'" />
                    </td>
                  </tr>
                </table>
			  </div>
