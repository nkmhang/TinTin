...
rs_KH_cmd.CommandText = "SELECT * FROM dbo.KhachHang ORDER BY MaKH DESC";
...
rs_KH_numRows += Repeat1__numRows;
%>
<!DOCTYPE html>
...
<!-- InstanceBeginEditable name="EditRegion3" -->
 <div class="shell">
        ...
        <div class="box">
          ...
          <div class="box-head">
			...
			function tim()
			{
				...
				window.location="tim_kh_admin.asp?user="+x;
			}
			</script>
             <div class="right">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <% while ((Repeat1__numRows-- != 0) && (!rs_KH.EOF)) { %>
      <tr>
